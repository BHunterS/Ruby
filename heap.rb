...
class MaxHeapSort
  def self.sort(arr)
    ...
    max_heap.heapify(arr.dup)
    sorted_array = []

    while max_heap.heap.any?
      sorted_array << max_heap.extract_root
    end
...
class MinHeapSort
  def self.sort(arr)
    ...
    min_heap.heapify(arr.dup)
    sorted_array = []

    while min_heap.heap.any?
      sorted_array << min_heap.extract_root
    end
...
sorted_array = MinHeapSort.sort(array.dup)
sorted_array_reverse = MaxHeapSort.sort(array.dup)

puts "Unsorted Array: #{array}"
puts "Sorted Array(min-heap): #{sorted_array}"
puts "Sorted Array(max-heap): #{sorted_array_reverse}"